...
public class differentialDrive extends CommandBase {
  ...
  public void execute() {
    ...
    m_drive.differentialDrive(m_controller.getRawAxis(Constants.XBOX_CONTROLLER_LEFT_Y_AXIS), m_controller.getRawAxis(Constants.XBOX_CONTROLLER_RIGHT_X_AXIS));
  }
